...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_UserInfo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(9, 174, 5)
    ...
    "UserInfo\0on_toolButton_3_clicked\0\0"
    "on_toolButton_4_clicked\0"
    "on_toolButton_13_clicked\0on_toolButton_clicked\0"
...
const QMetaObject UserInfo::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_UserInfo.data,
      qt_meta_data_UserInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_UserInfo.stringdata))
