...
BasicUser::BasicUser (const BasicUser& u): User(u.getName(), u.getSurname(), address = u.getAddress(), u.getTelephone(), u.getCode(), u.getUsername(), u.getPin()), countNumber(u.getCountNumber()), count(u.getCount()) {
    /*name = u.getName();
